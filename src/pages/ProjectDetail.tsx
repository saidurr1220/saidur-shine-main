...
import { ArrowLeft, ExternalLink, Target, Lightbulb, TrendingUp, Layers, CheckCircle2 } from "lucide-react";
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 selection:bg-emerald-500/30 selection:text-emerald-300">
      ...
      <main className="pt-28 pb-20 px-4">
        <div className="container mx-auto max-w-5xl">
          <Button variant="ghost" asChild className="mb-8 rounded-xl text-xs font-mono text-slate-400 hover:text-white">
            <Link to="/#projects">
            ...
            <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 mb-4">
              <div>
                ...
                <div className="flex flex-wrap items-center gap-2 text-slate-400">
                  ...
                  <Badge variant="outline" className="border-slate-800 font-mono text-xs">{project.filterCategory}</Badge>
              ...
              {project.url && project.url !== "" && (
                <Button asChild className="bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-bold rounded-xl h-11 px-5 shadow-lg shadow-emerald-500/20">
          ...
          <div className="rounded-3xl bg-slate-900/90 border border-slate-800 p-8 mb-8">
          ...
          <div className="space-y-6">
            <Card className="p-6 sm:p-8 bg-slate-900/80 border-slate-800 rounded-3xl shadow-xl">
          ...
          <div className="mt-12 text-center p-8 rounded-3xl bg-slate-900 border border-slate-800">
            ...
            <Button asChild size="lg" className="bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-bold rounded-xl">
