...
const services = [
  {
    ...
    description:
      "OOP-based WordPress plugins built from scratch - custom post types, hooks, filters, and AJAX-driven interfaces",
  },
  {
    icon: Palette,
    title: "Custom Theme Development",
    description:
      "Fully custom WordPress themes built from scratch, with modern UI and Elementor Pro customization",
  },
  {
    icon: Blocks,
    title: "WooCommerce Engineering",
    description:
      "Custom purchasing flows, inventory systems, and checkout logic on top of WooCommerce e-commerce",
  },
  {
    icon: Smartphone,
      ...
      <div className="container mx-auto max-w-6xl">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Custom WordPress development and WooCommerce engineering services for production-grade platforms
          </p>
        </motion.div>
