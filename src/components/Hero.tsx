...
export function Hero() {
  ...
  const fullText = "$ wp plugin activate --target=production";
  ...
  const techStack = [
    { icon: Code2, label: "WordPress", color: "text-blue-500" },
    { icon: Braces, label: "PHP", color: "text-indigo-400" },
    { icon: Server, label: "WooCommerce", color: "text-purple-500" },
    { icon: Database, label: "MySQL", color: "text-orange-500" },
    { icon: GitBranch, label: "JavaScript", color: "text-yellow-500" },
    { icon: Code2, label: "Elementor Pro", color: "text-cyan-500" },
  ];
            ...
            >
              ...
              <div className="p-4 font-mono text-sm">
                ...
                <div className="text-gray-400 text-xs space-y-1">
                  <div>✓ Building custom WordPress plugins...</div>
                  <div>✓ Configuring WooCommerce workflows...</div>
                  <div>✓ Optimizing Core Web Vitals...</div>
          ...
          >
            <div>
              ...
              >
                ...
                <span className="text-green-400">"Full Stack WordPress Developer"</span>;
              </motion.p>
              ...
              >
                Full stack WordPress developer specializing in custom plugin
                architecture and WooCommerce engineering. Built production-grade
                platforms with PHP, MySQL, and JavaScript &mdash; membership
                systems, booking engines, and CRM integrations for clients
              ...
              >
                {[
                  "Built 20+ custom WooCommerce modules for Vault Labs Research",
                  "Engineered membership & LMS platforms with Paid Memberships Pro",
                  "Delivered custom booking plugins with Stripe & Google Maps",
                ].map((highlight, i) => (
