...
export function FooterDev() {
  ...
  return (
    <footer className="border-t border-slate-800/80 bg-slate-950 py-16 px-4 relative overflow-hidden">
      <div className="container mx-auto max-w-7xl">
            ...
            <div className="flex gap-2.5 pt-2">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-9 h-9 rounded-xl bg-slate-900 hover:bg-emerald-500 hover:text-slate-950 border border-slate-800 flex items-center justify-center text-slate-300 transition-all duration-200"
        ...
        <div className="border-t border-slate-800 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-slate-400 font-mono">
