...
export function ExperienceUnique() {
  return (
    <section id="experience" className="py-28 px-4 bg-[#060813] relative overflow-hidden">
        ...
        <div className="space-y-8">
          {experienceData.map((item, index) => (
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <Card className="p-6 sm:p-8 bg-slate-900/85 backdrop-blur-2xl border border-white/10 rounded-3xl shadow-xl hover:border-emerald-500/40 transition-all duration-300 shimmer-border">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {item.techStack.map((tech) => (
                      <Badge
                        key={tech}
                        variant="secondary"
                        className="text-xs font-mono bg-white/[0.03] border border-white/10 text-slate-300 py-1 px-2.5 rounded-lg"
                      >
                        {tech}
                      </Badge>
                    ))}
                ...
                <div className="space-y-3 bg-white/[0.03] rounded-2xl p-5 border border-white/5">
          ...
          {educationData.map((edu, index) => (
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <Card className="p-6 sm:p-8 bg-slate-900/85 backdrop-blur-2xl border border-white/10 rounded-3xl shadow-xl hover:border-emerald-500/40 transition-all duration-300">
                <div className="flex items-start gap-4">
